  ...
  ipcMain.on('add-rssFeed', (event, rssFeedUrl, rssFeedDescription, rssFeedTopic) => {
    const newRssFeed = { id: "r" + (exampleFeedUrls.length + 1), url: rssFeedUrl, topic: rssFeedTopic, description: rssFeedDescription, subscribed:false };
    exampleFeedUrls.push(newRssFeed);
